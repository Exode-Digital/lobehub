...
describe('anthropicHelpers', () => {
        ...
        tool_calls: [
          {
            ...
            function: {
              name: 'search',
 // [sanitize invalid tool_call args before persist] Qwen shape — upstream sanitize should catch this, but
 ...
 // [context builder defense] — model emitted long writeLocalFile args containing many
