 ...
 * - {{model}} - Current model ID (requires [group-supervisor model/provider configuration])
 * - {{provider}} - Current provider (requires [group-supervisor model/provider configuration])
 */
