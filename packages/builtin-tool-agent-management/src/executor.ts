  ...
  callAgent = async (
    ...
    if (ctx.registerAfterCompletion) {
      ...
      ctx.registerAfterCompletion(async () => {
        ...
        // parent must keep the called sub-agent on the same path.         const parentAgentConfig = conversationContext.agentId
        ...
        // TODO: only client sub-agent dispatch is wired.
