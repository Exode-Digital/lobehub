...
describe('AgentRuntime', () => {
 ...
 // Regression test for [Gemini 3 thoughtSignature round-trip survival]: Gemini 3 thoughtSignature must survive the
 ...
 describe('Multi-Round Batch Tool Execution ', () => {
    /**
 * This test verifies the fix for [multi-round batch tool execution]:
