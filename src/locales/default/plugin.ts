export default {
  ...
  'builtins.lobe-image-generation.apiName.getImageGenerationStatus': 'Get image status',
  'builtins.lobe-image-generation.apiName.getImageModelParameters': 'Get image model parameters',
